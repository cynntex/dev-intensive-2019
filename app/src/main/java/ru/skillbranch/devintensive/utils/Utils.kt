...
//    return Pair(firstName, lastName)
    ...
    fun transliteration(payload: String, divider: String = " "): String {
        val transliterationMap: Map<String, String> = mapOf(
            ...
            "ъ" to "",  "ы" to "i", "ь" to "",  "э" to "e", "ю" to "yu", "я" to "ya", "А" to "A", "Б" to "B",
            "В" to "V", "Г" to "G", "Д" to "D", "Е" to "E", "Ё" to "E", "Ж" to "Zh", "З" to "Z", "И" to "I", "Й" to "I",
            "К" to "K", "Л" to "L", "М" to "M", "Н" to "N", "О" to "O", "П" to "P", "Р" to "R", "С" to "S", "Т" to "T",
        ...
        return payload.map{ item: Char -> transliterationMap.getOrElse("$item") { item }}
            .joinToString(separator = "").replace (" ", divider)
    ...
    fun toInitials(firstName: String?, lastName: String?): String? {
        ...
        return if ("$firstChar$lastChar".equals("")) null else "$firstChar$lastChar"
